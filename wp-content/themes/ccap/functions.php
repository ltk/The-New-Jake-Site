...
/**
  All of our custom functions are namedspaced by the "Jake" class.
 */
require_once locate_template('/inc/classes/Jake.class.php');          // Custom utility class
...
function roots_setup() {
  ...
  register_nav_menus(array(
    ...
    'action_navigation' => __('Action Navigation', 'roots'),
